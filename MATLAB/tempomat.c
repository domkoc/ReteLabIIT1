 ...
 *  ------------------------------------------------------------------------- 
 *
 * Created: Mon Apr 12 17:27:36 2021
 */

#define S_FUNCTION_LEVEL 2
#define S_FUNCTION_NAME tempomat
/*<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<<*/
...
extern void tempomat_Outputs_wrapper(const real_T *speed,
			const real_T *pedal,
			const real_T *onoff,
			real_T *output,
			const real_T *xD,
...
extern void tempomat_Update_wrapper(const real_T *speed,
			const real_T *pedal,
			const real_T *onoff,
			real_T *output,
			real_T *xD,
...
{
    const real_T *speed = (real_T *) ssGetInputPortRealSignal(S, 0);
    const real_T *pedal = (real_T *) ssGetInputPortRealSignal(S, 1);
    const real_T *onoff = (real_T *) ssGetInputPortRealSignal(S, 2);
    ...
    const real_T *Ki = (const real_T *) mxGetData(PARAM_DEF1(S));
    
    tempomat_Outputs_wrapper(speed, pedal, onoff, output, xD, Kp, p_width0, Ki, p_width1);
...
static void mdlUpdate(SimStruct *S, int_T tid)
{
    ...
    tempomat_Update_wrapper(speed, pedal, onoff, output, xD, Kp, p_width0, Ki, p_width1);
