...
MAKECMD         = "C:/PROGRA~1/MATLAB/R2018a/bin/win64/gmake"
HOST            = ANY
BUILD           = yes
...
MODEL                := external_jarmu
MODULES              := external_jarmu_data.c external_jarmu_tgtconn.c rtGetInf.c rtGetNaN.c rt_nonfinite.c
MAKEFILE             := external_jarmu.mk
...
SLDRTDIR             := C:/PROGRA~1/MATLAB/R2018a/toolbox/sldrt
TARGETARCH           := win64
CC_LISTING           := 0
REBUILD_ALL          := 0
...
#
MODELLIB                  := external_jarmulib_sldrt.lib
MODELREF_LINK_LIBS        := 
MODELREF_LINK_RSPFILE     := external_jarmu_ref.rsp
MODELREF_INC_PATH         := 
...
# additional includes
REQ_INCLUDES += ;C:/Users/cloud/Documents/MATLAB;C:/Users/cloud/Documents/MATLAB/external_jarmu_sldrt_win64;$(MATLAB_ROOT)/extern/include;$(MATLAB_ROOT)/simulink/include;$(MATLAB_ROOT)/rtw/c/src;$(MATLAB_ROOT)/rtw/c/src/ext_mode/common
